...
export const en: LocaleStrings = {
  ...
  models: {
    ...
    clientTypeZenMaxGemini: 'Gemini',
    clientTypeZenMaxClaude: 'Claude',
  ...
  knowledgeBases: {
    ...
    nameLabel: 'Name',
    namePlaceholder: 'e.g. University Physics I',
    descriptionLabel: 'Description',
    refresh: 'Refresh',
    back: 'Back',
    empty: 'No knowledge bases yet',
    workspaceResolving: 'Resolving default workspace...',
    workspaceHint: (workspaceRef: string) => `Current workspace: ${workspaceRef}`,
    colName: 'Name',
    ...
    deleteConfirm: (name: string) => `Delete "${name}" and all of its documents?`,
    noDescription: 'No description',
    docsTitle: 'Documents',
    docsEmpty: 'No documents yet. Upload a .txt, .md, .pdf, .docx, or image file.',
    ...
    upload: 'Upload',
    uploading: 'Uploading...',
    searchTitle: 'Search (debug)',
    searchPlaceholder: 'Type a query and press Enter...',
    search: 'Search',
    score: 'score',
    paragraph: (ordinal: number) => `paragraph ${ordinal}`,
    chunkTypes: {
      paragraph: 'Paragraph',
      heading: 'Heading',
      image: 'Image',
    ...
    docDeleteConfirm: (filename: string) => `Delete "${filename}" and its chunks?`,
