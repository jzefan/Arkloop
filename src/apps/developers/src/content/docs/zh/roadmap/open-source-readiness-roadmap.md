...
threadMessageLimit(200)、maxInputContentBytes(32KB)、defaultReasoningIterations(10)、maxParallelTasks(32)、entitlement 默认限制（默认 `0` 表示不限）等限制硬编码在代码中，无集中注册、无文档暴露、Console 无法修改。用户和开发者在遇到限制时才知道它存在。
