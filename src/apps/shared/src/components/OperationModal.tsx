...
import type { BridgeOperationsClient, ModuleAction } from './OperationContext'
...
export function OperationModal({ moduleName, action, operationId, client, onClose }: Props) {
