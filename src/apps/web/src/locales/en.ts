...
export const en: LocaleStrings = {
  ...
  isolation: {
    ...
    description: "Choose how shell commands are executed. Trusted mode runs directly on your machine; VM mode runs inside an isolated Apple virtual machine.",
    unsupported: "VM isolation is only available on macOS.",
    trustedTitle: "Trusted Local",
    trustedDesc: "Commands run directly on your machine. Fast and full access to your filesystem and tools.",
    vmTitle: "Apple VM",
    vmDesc: "Commands run in an isolated virtual machine using Apple Virtualization.framework. Safer but slightly slower.",
    vmImagesRequired: "Images required",
    vmImagesTitle: "VM Images",
    vmKernelRootfs: "Kernel & Root Filesystem",
    vmInstalled: "Installed and ready",
    vmCustomInstalled: "Using local files",
    vmNotInstalled: "Not installed",
    vmDownloading: "Downloading…",
    vmDownloadError: "Download failed",
    vmDownload: "Download",
    vmDelete: "Remove",
    vmConnecting: "Connecting…",
    vmExtracting: "Extracting…",
    devLocalPathsTitle: "Use Local Files (Developer)",
    devLocalPathsDesc: "Point to existing VM assets on disk instead of downloading. Files are not copied — the paths are used directly. Useful for local development with /tmp/vz-test/ assets.",
    devKernelPath: "Kernel path (vmlinux / vmlinuz)",
    devRootfsPath: "Root filesystem path (.ext4)",
    devInitrdPath: "Initrd path",
    devOptional: "optional",
    devApply: "Apply paths",
    devClear: "Clear",
    note: "Switching isolation mode requires a sidecar restart. File read/write operations always use local filesystem access regardless of isolation mode.",
  },
