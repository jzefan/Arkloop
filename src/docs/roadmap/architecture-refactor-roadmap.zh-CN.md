...
Phase 1-4 是核心路径，Phase 4.5 是 Phase 5 的前置条件。Phase 5-6 可根据产品优先级调整顺序。Phase 6.5 在 Phase 6 功能验收完成后执行，与 Phase 7 可并行推进（Console 开发不阻塞性能优化）。同一 Phase 内无强依赖的薄片可并行执行。
