...
ALTER TABLE messages RENAME TO messages_old_00071;
...
SELECT
    id, thread_id, account_id, thread_seq, created_by_user_id, role, content, content_json,
    metadata_json, hidden, deleted_at, token_count, created_at
FROM messages_old_00071;

ALTER TABLE channel_message_ledger RENAME TO channel_message_ledger_old_00071;
...
SELECT
    ...
    platform_message_id, platform_parent_message_id, platform_thread_id,
    sender_channel_identity_id, metadata_json, created_at, message_id
FROM channel_message_ledger_old_00071;

DROP TABLE messages_old_00071;
DROP TABLE channel_message_ledger_old_00071;
