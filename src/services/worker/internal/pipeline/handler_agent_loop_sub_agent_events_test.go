...
func TestEventWriterAppend_AppendsSubAgentCompletedEvent(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: orgID, ThreadID: threadID}, "trace-1", nil, nil, "", "", data.UsageRecordsRepository{}, data.CreditsRepository{}, 1000, 1, nil, nil, nil, nil, creditpolicy.DefaultPolicy)
...
func TestEventWriterAppend_AppendsSubAgentCancelledEventOnCancelRequest(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: orgID, ThreadID: threadID}, "trace-2", nil, nil, "", "", data.UsageRecordsRepository{}, data.CreditsRepository{}, 1000, 1, nil, nil, nil, nil, creditpolicy.DefaultPolicy)
...
func TestEventWriterAppend_AutoQueuesNextRunFromPendingInputs(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: childRunID, AccountID: orgID, ThreadID: childThreadID, ParentRunID: &parentRunID}, "trace-3", nil, jobQueue, "", "", data.UsageRecordsRepository{}, data.CreditsRepository{}, 1000, 1, nil, nil, nil, nil, creditpolicy.DefaultPolicy)
