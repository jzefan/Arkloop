...
func AgentSpecs() []tools.AgentToolSpec {
	return []tools.AgentToolSpec{
		...
		kb.AgentSpec,
		kb.ExtractTOCAgentSpec,
		kb.ListKnowledgeBasesAgentSpec,
		kb.ListKnowledgePointsAgentSpec,
		kb.DraftQuestionsAgentSpec,
		kb.SaveQuestionsAgentSpec,
		kb.ComposePaperAgentSpec,
		kb.PaperWizardAgentSpec,
		read.AgentSpec,
...
func LlmSpecs() []llm.ToolSpec {
	return []llm.ToolSpec{
		...
		webfetch.LlmSpec,
		kb.LlmSpec,
		kb.ExtractTOCLlmSpec,
		kb.ListKnowledgeBasesLlmSpec,
		kb.ListKnowledgePointsLlmSpec,
		kb.DraftQuestionsLlmSpec,
		kb.SaveQuestionsLlmSpec,
		kb.ComposePaperLlmSpec,
		kb.PaperWizardLlmSpec,
		read.LlmSpec,
		writefile.LlmSpec,
		edit.LlmSpec,
		glob.LlmSpec,
...
func Executors(pool *pgxpool.Pool, rdb *redis.Client, resolver sharedconfig.Resolver, skillStore objectstore.Store) (map[string]tools.Executor, *fileops.FileTracker) {
	...
	return map[string]tools.Executor{
		...
		kb.AgentSpec.Name:                    kbExec,
		kb.ExtractTOCAgentSpec.Name:          kbExec,
		kb.ListKnowledgeBasesAgentSpec.Name:  kbExec,
		kb.ListKnowledgePointsAgentSpec.Name: kbExec,
		kb.DraftQuestionsAgentSpec.Name:      kbExec,
		kb.SaveQuestionsAgentSpec.Name:       kbExec,
		kb.ComposePaperAgentSpec.Name:        kbExec,
		kb.PaperWizardAgentSpec.Name:         kbExec,
